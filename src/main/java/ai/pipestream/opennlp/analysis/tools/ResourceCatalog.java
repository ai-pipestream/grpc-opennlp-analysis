...
final class ResourceCatalog {
  ...
  private static final Map<String, Entry> ENTRIES = Map.ofEntries(
      ...
      Map.entry("pos-en-ud-ewt", new Entry(
          "pos-en-ud-ewt",
      ...
      Map.entry("ner-en-person", new Entry(
          "ner-en-person",
          ...
          List.of(
              "OPENNLP_NER_MODEL=en-ner-person.bin (the setting takes a list: "
                  + "separate several models with the path separator or a comma)"))),
      Map.entry("ner-en-location", new Entry(
          "ner-en-location",
          ...
          List.of(
              "OPENNLP_NER_MODEL=en-ner-location.bin (see ner-en-person: several "
                  + "models can be named at once)"))),
      Map.entry("ner-en-organization", new Entry(
          "ner-en-organization",
          ...
          List.of(
              "OPENNLP_NER_MODEL=en-ner-organization.bin (append to the list)"))),
      Map.entry("ner-en-date", new Entry(
          "ner-en-date",
          ...
          List.of(
              URI.create("https://opennlp.sourceforge.net/models-1.5/"
                  + "en-ner-date.bin")),
          List.of(
              "OPENNLP_NER_MODEL=en-ner-date.bin (append to the list)"))),
      Map.entry("ner-en-time", new Entry(
          "ner-en-time",
          ...
          List.of(
              URI.create("https://opennlp.sourceforge.net/models-1.5/"
                  + "en-ner-time.bin")),
          List.of(
              "OPENNLP_NER_MODEL=en-ner-time.bin (append to the list)"))),
      Map.entry("ner-en-money", new Entry(
          "ner-en-money",
          ...
          List.of(
              URI.create("https://opennlp.sourceforge.net/models-1.5/"
                  + "en-ner-money.bin")),
          List.of(
              "OPENNLP_NER_MODEL=en-ner-money.bin (append to the list)"))),
      Map.entry("ner-en-percentage", new Entry(
          "ner-en-percentage",
          ...
          List.of(
              "OPENNLP_NER_MODEL=en-ner-percentage.bin (append to the list)"))),
      Map.entry("wordnet-en", new Entry(
          "wordnet-en",
      ...
      Map.entry("morfologik-en", new Entry(
          "morfologik-en",
